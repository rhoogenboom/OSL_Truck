...
// ------------------------------------------------------------------------------------------------------------------------------------------------>
    ...
    #define TurnSignalDelay_mS        1500          // If BlinkTurnOnlyAtStop = true, this setting further refines when the turn signals can come on. Instead of coming on right when the 
    ...
    #define TurnFromStartContinue_mS  4000          // If BlinkTurnOnlyAtStop = true, this setting determines the length of time the turn signal will continue to blink when you begin moving from 
...
// ------------------------------------------------------------------------------------------------------------------------------------------------>
    ...
    #define TimeToStop_REV_mS          200          // An estimate of the time usually spent coasting to a stop fro reverse. During this time, forward commands will be counted as braking
